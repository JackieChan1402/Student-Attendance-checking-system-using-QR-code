...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 145, ; uint32_t number_of_assemblies_in_apk (0x91)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 694, ; uint32_t number_of_dso_cache_entries (0x2b6)
	i32 33555186, ; uint32_t android_runtime_jnienv_class_token (0x20002f2)
	i32 100671136, ; uint32_t jnienv_initialize_method_token (0x6001ea0)
	i32 100671135, ; uint32_t jnienv_registerjninatives_method_token (0x6001e9f)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [694 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.83_name, ; name: libaot-System.Net.Http.Json.dll.so
		ptr null; void* handle (0x0)
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.56_name, ; name: libaot-Xamarin.Google.Crypto.Tink.Android.dll.so
		ptr null; void* handle (0x0)
	}, ; 15
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.61_name, ; name: libaot-ZXing.Net.MAUI.dll.so
		ptr null; void* handle (0x0)
	}, ; 38
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so
		ptr null; void* handle (0x0)
	}, ; 55
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.57_name, ; name: libaot-Xamarin.Google.Guava.ListenableFuture.dll.so
		ptr null; void* handle (0x0)
	}, ; 63
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-Xamarin.AndroidX.Camera.Lifecycle.dll.so
		ptr null; void* handle (0x0)
	}, ; 65
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.62_name, ; name: libaot-ZXing.Net.MAUI.Controls.dll.so
		ptr null; void* handle (0x0)
	}, ; 92
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.60_name, ; name: libaot-zxing.dll.so
		ptr null; void* handle (0x0)
	}, ; 113
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.29_name, ; name: libaot-Xamarin.AndroidX.Camera.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.31_name, ; name: libaot-Xamarin.AndroidX.Camera.View.dll.so
		ptr null; void* handle (0x0)
	}, ; 154
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5421916948542086128, ; hash 0x4b3e84bcf7855bf0, from name: libaot-Mobile App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.85_name, ; name: libaot-System.Net.Mail.dll.so
		ptr null; void* handle (0x0)
	}, ; 191
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5900181720004311900, ; hash 0x51e1a8038b1c3b5c, from name: libaot-Mobile App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 196
	...
	%struct.DSOCacheEntry {
		i64 10134331399095559990, ; hash 0x8ca460b6a72da736, from name: Mobile App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 373
	...
	%struct.DSOCacheEntry {
		i64 10337145831660568506, ; hash 0x8f74eb5d8789bfba, from name: aot-Mobile App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 380
	...
	%struct.DSOCacheEntry {
		i64 10727734529578474116, ; hash 0x94e091b778379a84, from name: aot-Mobile App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 398
	...
	%struct.DSOCacheEntry {
		i64 12875752488719010386, ; hash 0xb2afdcab79f2ca52, from name: Mobile App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 484
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [145 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.3 = private unnamed_addr constant [37 x i8] c"cb15f8b4-9b41-4162-918c-e7a02dc9225e\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.mobileapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-Mobile App.dll.so\00", align 16
...
@.DSOCacheEntry.29_name = private unnamed_addr constant [43 x i8] c"libaot-Xamarin.AndroidX.Camera.Core.dll.so\00", align 16
@.DSOCacheEntry.30_name = private unnamed_addr constant [48 x i8] c"libaot-Xamarin.AndroidX.Camera.Lifecycle.dll.so\00", align 16
@.DSOCacheEntry.31_name = private unnamed_addr constant [43 x i8] c"libaot-Xamarin.AndroidX.Camera.View.dll.so\00", align 16
...
@.DSOCacheEntry.51_name = private unnamed_addr constant [55 x i8] c"libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so\00", align 16
...
@.DSOCacheEntry.56_name = private unnamed_addr constant [49 x i8] c"libaot-Xamarin.Google.Crypto.Tink.Android.dll.so\00", align 16
@.DSOCacheEntry.57_name = private unnamed_addr constant [52 x i8] c"libaot-Xamarin.Google.Guava.ListenableFuture.dll.so\00", align 16
...
@.DSOCacheEntry.60_name = private unnamed_addr constant [20 x i8] c"libaot-zxing.dll.so\00", align 16
@.DSOCacheEntry.61_name = private unnamed_addr constant [29 x i8] c"libaot-ZXing.Net.MAUI.dll.so\00", align 16
@.DSOCacheEntry.62_name = private unnamed_addr constant [38 x i8] c"libaot-ZXing.Net.MAUI.Controls.dll.so\00", align 16
...
@.DSOCacheEntry.83_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.Http.Json.dll.so\00", align 16
@.DSOCacheEntry.84_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Http.dll.so\00", align 16
@.DSOCacheEntry.85_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
