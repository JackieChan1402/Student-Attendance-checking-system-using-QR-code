...
@dso_cache = dso_local local_unnamed_addr global [694 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1041017394, ; hash 0x3e0caa32, from name: libaot-Mobile App
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1094760784, ; hash 0x4140b950, from name: aot-Mobile App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 171
	...
	%struct.DSOCacheEntry {
		i64 1349509064, ; hash 0x506fdfc8, from name: libaot-Mobile App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 2175352163, ; hash 0x81a93d63, from name: Mobile App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 358
	...
	%struct.DSOCacheEntry {
		i64 2875976773, ; hash 0xab6bec45, from name: aot-Mobile App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 476
	...
	%struct.DSOCacheEntry {
		i64 3479483135, ; hash 0xcf64b2ff, from name: Mobile App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Mobile App.dll.so
		ptr null; void* handle (0x0)
	}, ; 570
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [145 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
